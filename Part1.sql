DECLARE
	...
	command3 varchar2(10000) := 'CREATE TABLE Grade (s_ID integer, c_ID varchar2(9),mark integer, PRIMARY KEY (s_ID, c_ID), FOREIGN KEY (s_ID) REFERENCES Student(s_ID), FOREIGN KEY (c_ID) REFERENCES Course(c_ID))';
