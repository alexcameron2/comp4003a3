...
--	command3 varchar2(10000) := 'CREATE TABLE Grade (student integer, course varchar2(9), integer mark, PRIMARY KEY (student, course), FOREIGN KEY (student) REFERENCES Student(s_ID), FOREIGN KEY (course) REFERENCES Course(c_ID))';
