...
DECLARE
	command1 varchar2(200) := 'CREATE TABLE Student (s_ID integer AUTO_INCREMENT PRIMARY KEY, s_name varchar2(14) NOT NULL, s_birth varchar2(9), s_addr varchar2(10), UNIQUE(s_name))';
